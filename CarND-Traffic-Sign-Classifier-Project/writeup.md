...
Visually equalize_adapthist looks better.However, equalize_adapthist has precision loss when converting from float64 to uint16.In the end, adjust_gamma has a better accuracy.
...
The difference between the original data set and the augmented data set is the augmented date is rotated +-15 and rescaled 80% or 120%.
